...
namespace WindowsBlogReader
{
    ...
    public sealed partial class SplitPage : Page
    {
        ...
        public SplitPage()
        {
            ...
            this.navigationHelper.GoBackCommand = new WindowsBlogReader.Common.RelayCommand(() => this.GoBack(), () => this.CanGoBack());
        ...
        private void ContentView_OnNavigationFailed(object sender, WebViewNavigationFailedEventArgs e)
        {
